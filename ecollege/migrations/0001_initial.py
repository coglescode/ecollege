# Generated by Django 3.1.2 on 2021-10-27 22:47

from django.conf import settings
from django.db import migrations, models
import django.db.models.deletion
import ecollege.fields
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', ecollege.fields.OrderField(blank=True)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='modules', to='ecollege.course')),
            ],
            options={
                'ordering': ['order'],
            },
        ...
        migrations.AddField(
            model_name='course',
            name='subject',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='ecollege.subject'),
        ),
        migrations.CreateModel(
            name='Content',
            fields=[
                ...
                ('module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contents', to='ecollege.module')),
            ],
            options={
                'ordering': ['order'],
            },
